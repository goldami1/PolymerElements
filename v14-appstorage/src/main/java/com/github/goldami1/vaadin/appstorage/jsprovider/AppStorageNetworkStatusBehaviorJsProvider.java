...
//@Tag("app-storage-networkstatus-behavior")
//@JsModule("./js/app-storage-networkstatus-behavior.js")
...
*/
public class AppStorageNetworkStatusBehaviorJsProvider extends Component
{
	private static final long serialVersionUID = 6584173606720211056L;

	public AppStorageNetworkStatusBehaviorJsProvider()
	{
