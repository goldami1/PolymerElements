...
@Tag("app-storage-behavior")
@JsModule("./js/app-storage-behavior.js")
...
*/
public class AppStorageBehaviorJsProvider extends Component
{
	private static final long serialVersionUID = 6584173606720211056L;

	public AppStorageBehaviorJsProvider()
	{
