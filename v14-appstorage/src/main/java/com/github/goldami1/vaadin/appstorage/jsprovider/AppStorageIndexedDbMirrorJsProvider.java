...
//@Tag("app-storage-indexeddb-mirror")
//@JsModule("./js/app-storage-indexeddb-mirror.js")
...
*/
public class AppStorageIndexedDbMirrorJsProvider extends Component
{
	private static final long serialVersionUID = 6584173606720211056L;

	public AppStorageIndexedDbMirrorJsProvider()
	{
